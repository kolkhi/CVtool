...
#define MGL_VER2 	4.2	// minor version of MathGL 2.* (like 1.3 for v.2.1.3)
#define MGL_VER_MAJOR 	2
#define MGL_VER_MINOR 	4
#define MGL_VER_PATCH 	2
#define MGL_VERSION 	(2000+4.2)
#define MGL_VER_STRING 	"2.4.2"
...
#define MGL_FONT_PATH	"./build/fonts"
#define MGL_HAVE_FL_COPY	0
